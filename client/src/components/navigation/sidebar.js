    ...
    return(
        <nav className="col-md-2 d-none d-md-block sidebar fixed-top sidebarColor">
            <div className="sidebar-sticky">
                <Link className="nav-link lightText container-fluid sidebarAlt" to="">
                    <h6>
                ...
                <ul className="nav flex-column">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link lightText sidebarColor" to="">
                            <h6>
                    ...
                    <Link className="nav-link lightText container-fluid sidebarAlt bottom" to="/logout">
                        <h6>
